...
app.post('/create-checkout-session', async (req, res) => {
  const { product, price, quantity, color, textColor, baseColor, outerColor, innerColor, boxColor, fingerColor, batteryType, spotify, email, address, fullName, paymentMethod } = req.body;
